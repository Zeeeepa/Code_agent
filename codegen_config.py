...
This module provides centralized configuration management for all CodeGen components:
- Issue Solver
- Context Manager
- CI/CD Workflow
...
2. Configuration file (codegen_config.json)
...
class CodeGenConfig:
    """Manages configuration for all CodeGen components."""
    ...
    def _load_from_file(self, config_path: str = "codegen_config.json"):
    ...
    def save_to_file(self, config_path: str = "codegen_config.json"):
...
def init_config_from_args(args: argparse.Namespace) -> CodeGenConfig:
